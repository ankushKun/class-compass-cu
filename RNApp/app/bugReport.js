    ...
    return (
        <View style={{ ...styles.base }}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", backgroundColor: "#d6a64f", paddingHorizontal: 5, paddingVertical: 26, marginBottom: 10 }}>
                <Text style={{ color: "black", fontSize: 20, textAlign: "left", paddingLeft: 72, fontWeight: "bold" }}>Report Bug</Text>
            ...
            <View style={{ alignItems: "center", gap: 20 }}>
                <TextInput style={{ color: "white", padding: 10, borderRadius: 15, backgroundColor: "#292d2e", width: "80%" }}
                    placeholder="Describe the bug here. Add as much details as possible and a link to the video (screenrecord) of the bug and let us know how to reproduce the bug." multiline placeholderTextColor="gray"
